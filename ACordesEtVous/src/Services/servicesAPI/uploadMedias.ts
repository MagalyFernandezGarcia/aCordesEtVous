...
export const uploadMedia = async (
	...
	const formattedPhoto = {
		...
		post_date_gmt: normalizeDate(
			photoData.post_date_gmt ?? new Date().toISOString()
		),
		...
		post_modified: normalizeDate(
			photoData.post_modified ?? new Date().toISOString()
		),
		post_modified_gmt: normalizeDate(
			photoData.post_modified_gmt ?? new Date().toISOString()
		),
